...
REPO_URL = 'https://github.com/sluggets/goat-list.git'
...
def _update_settings(source_folder, site_name):
    ...
    # Not sure if the below should be in the automation as well.
    #sed(settings_path, "TEMPLATE_DEBUG = True", "TEMPLATE_DEBUG = DEBUG") 
